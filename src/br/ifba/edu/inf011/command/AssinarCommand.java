...
public class AssinarCommand implements DocumentoCommand {

    private final GerenciadorDocumentoModel receiver;
    private Documento antes;
    private Documento depois;

    public AssinarCommand(GerenciadorDocumentoModel receiver) {
    ...
    public void execute() throws Exception {
        ...
        this.depois = receiver.assinarDocumento(antes);
    }
